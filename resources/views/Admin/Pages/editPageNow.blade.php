...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Dhuaa Page</h1>
    </div>
</div>
        ...
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">
                <form method="post" action="/Pages/EditPage" enctype="multipart/form-data">
                    ...
                    try{
                        //LongDescription
 $r=Storage::disk('local')->get("/longDescArticle/".$pageInfo->content);
                    ...
                    <div class="row" style="padding:50px;">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <p> Title </p>
                                    <input type="text" name="title" class="form-control" value="{{$pageInfo->title}}" />
                                    <input type="hidden" name="id" class="form-control" value="{{$pageInfo->id}}" />
                                    <span style="color:red;">
                                        @error('title')
                                        {{$message}}
                                        @enderror
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input name="tags" id="tags" value="dhuaa,tyre" class="form-control" value="{{$pageInfo->keywords}} />
                                        </div>
                                    </div>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <textarea name="shortdescription" class="form-control"
                                        style="height:100px;">{{$pageInfo->description}}</textarea>
                                    <span style="color:red;">
