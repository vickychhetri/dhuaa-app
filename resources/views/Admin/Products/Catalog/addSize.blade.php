...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"> Add Model Option Size </h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="box dark">
            <header>
                ...
                <h5>Add New Product Model Option Size </h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
            ...
            <div id="div-1" class="accordion-body collapse in body">
                <form class="form-horizontal" action="/Admin/Catalog/Modeloption" method="post">
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4"> Size</label>
                        <div class="col-lg-8">
                            <input type="text" id="text1" placeholder="Option Size" class="form-control"
                                name="optionSize" />
