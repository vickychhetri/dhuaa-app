            ...
            <div id="div-1" class="accordion-body collapse in body">
                <form class="form-horizontal" action="/Admin/Catalog/Modeloption" method="post">
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4"> Year-Brand-Model </label>
                        <div class="col-lg-8">
                            <select class="form-control" name="modelId">
                                @foreach($ModelOption as $MODEL)
                                <option value="{{$MODEL->id}}"> {{$MODEL->year}} - {{$MODEL->brand}} - {{$MODEL->model}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4"> Option Name </label>
                        <div class="col-lg-8">
                            <input type="text" id="text1" placeholder="Option Name" class="form-control"
                                name="optionName" />
...
<hr />
<x-Administrator.Product.Catalog.Listmodeloption/>
@endsection
