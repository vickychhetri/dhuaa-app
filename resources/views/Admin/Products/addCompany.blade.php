    ...
    <div class="col-lg-12">
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">
                <form class="form-horizontal" action="/Admin/Add-Company" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Name of the Company</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" placeholder="Email" class="form-control" name="CompanyName" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select data-placeholder="Choose a Country" name="TypeCompany" class="form-control chzn-select" tabindex="2">
                                <option value="United States">Finanace</option>
                                <option value="United Kingdom">Transport</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select data-placeholder="Choose a Country" name="Country" class="form-control chzn-select" tabindex="2">
