...
<div class="row">
    <div class="col-lg-12">
        <div class="box dark">
            ...
            @if(isset($addtional))
            <form class="form-horizontal" action="/Admin/Product/EAddtional-Information"
                 method="post">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="text3" class="control-label col-lg-4"> Addtional Information </label>

                        <div class="col-lg-8">
                            <input type="hidden" name="id" value="{{$addtional->id}}"/>
                                <textarea id="text3" class="form-control"
                                 name="MoreInformation" >{{$addtional->typeofContentValue}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                @else 
                <form class="form-horizontal" action="/Admin/Product/Addtional-Information"
                 method="post">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4"> Addtional Information </label>

                        <div class="col-lg-8">
                            <input type="hidden" name="productId" value="{{$productId}}"/>
                                <textarea id="text1" class="form-control"
                                 name="MoreInformation" ></textarea>
                        </div>
                    </div>
