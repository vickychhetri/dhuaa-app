                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    @foreach ($listproductbase as $product)
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td class="center"> <a href="/Admin/Edit-Product-Info/{{ $product->id}}" class="btn btn-primary"> Edit</a> </td>
                            <td class="center"> <a href="/Admin/Delete-Products-Info/{{ $product->id}}" class="btn btn-danger"> delete</a> </td>
                        </tr>
                       @endforeach
