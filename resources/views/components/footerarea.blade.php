                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-widget">
                            ...
                            <div class="text">
                                <p> 
                                     {{env('APPLICATION_NAME')}}  is Jalandhar City’s premier service 
                                     & repair facility for truck 
                                     owners who desire the fastest turnaround time,
                                      the best rates and one-on-one personal service.
<!-- 
                                       Tired of being pushed around by the mega franchise dealers?
                                        Tired of your neighborhood mechanic not being fully qualified for your
                                         equipment? We are a family owned and operated shop dedicated to
                                          maintaining your commercial delivery truck from bumper to bumper.
                                           We cater to owner operators as well as national fleets. -->
                                            Getting you back on
                                      the road fast, affordable and with the job done right is our
                                       specialty.
                                    
                                    </p>
                                <a class="aut-cr-btn" href="">Contact Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-widget">
                            ...
                            <ul class="service-list">
                                <li><a href=""><i class="fa fa-angle-right" aria-hidden="true"></i>Roadside Services, Onsite Repair</a></li>
                                <li><a href=""><i class="fa fa-angle-right" aria-hidden="true"></i>Truck, Trailer & Tire Repair</a></li>
                                        ...
                                        <ul class="shop-spare">
                                            <li>
                                                <div class="img-holder">
                                                    <img src="img/footer/shop-spare/1.png" alt="">
                                                </div>
                                                <div class="content">
                                            ...
                                            <li>
                                                <div class="img-holder">
                                                    <img src="img/footer/shop-spare/2.png" alt="">
                                                </div>
                                                <div class="content">
